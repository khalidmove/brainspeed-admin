...
import { MdOutlineKeyboardDoubleArrowLeft, MdKeyboardArrowLeft, MdOutlineKeyboardArrowRight, MdOutlineKeyboardDoubleArrowRight } from "react-icons/md";
...
function GlobalFilter({
  ...
  return (
    <label className="w-full flex justify-end items-center gap-x-2 md:items-baseline md:px-0 py-5">
      ...
      <input
        type="text"
        className="rounded-md  p-2 w-96 border border-[var(--dark-orange)] shadow-sm outline-none"
        value={value || ""}
        onChange={(e) => {
...
function Table({ columns, data, refs }) {
  ...
  return (
    <>
      ...
      {/* table */}
      <div className="flex flex-col rounded-xl border-[var(--dark-orange)] border-2">
          ...
          <div className="py-2 align-middle inline-block min-w-full ">
            <div className="shadow overflow-hidden  sm:rounded-lg">
              <table
                ...
                ref={refs}
              >
                <thead className="bg-transparent  border-b-2 border-[var(--dark-orange)] rounded-xl pb-1">
